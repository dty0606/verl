...
ARGS=(
    ...
    "tau3.sdpo.decision_weighting.enabled=${SDPO_DECISION_WEIGHTING_ENABLED:-false}"
    "tau3.sdpo.decision_weighting.shadow_mode=${SDPO_DECISION_WEIGHTING_SHADOW_MODE:-true}"
    "tau3.sdpo.decision_weighting.apply_to_loss=${SDPO_DECISION_WEIGHTING_APPLY_TO_LOSS:-false}"
    "tau3.sdpo.decision_weighting.base_weight=${SDPO_DECISION_WEIGHTING_BASE_WEIGHT:-1.0}"
    "tau3.sdpo.decision_weighting.decision_span_weight=${SDPO_DECISION_WEIGHTING_DECISION_SPAN_WEIGHT:-1.0}"
    "tau3.sdpo.decision_weighting.tool_action_weight=${SDPO_DECISION_WEIGHTING_TOOL_ACTION_WEIGHT:-1.0}"
    "tau3.sdpo.decision_weighting.write_action_weight=${SDPO_DECISION_WEIGHTING_WRITE_ACTION_WEIGHT:-1.0}"
    "tau3.sdpo.decision_weighting.final_answer_weight=${SDPO_DECISION_WEIGHTING_FINAL_ANSWER_WEIGHT:-1.0}"
    "tau3.sdpo.decision_weighting.short_unsolved_chars=${SDPO_DECISION_WEIGHTING_SHORT_UNSOLVED_CHARS:-160}"
