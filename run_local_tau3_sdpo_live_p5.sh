...
EXP_NAME="LOCAL-TAU3-SDPO-${FEEDBACK_MODE}-${MODEL_NAME}-${SUFFIX}"
...
ARGS=(
    ...
    "tau3.sdpo.max_reprompt_len=${SDPO_MAX_REPROMPT_LEN:-8192}"
...
echo "SDPO max reprompt len: ${SDPO_MAX_REPROMPT_LEN:-8192}"
echo "----------------------------------------------------------------"
