...
TAU3_LIVE_ALL_MESSAGES_AS_OBSERVATION="${TAU3_LIVE_ALL_MESSAGES_AS_OBSERVATION:-0}"
...
DOCKER_ARGS=(
    ...
    -e "TAU3_LIVE_ALL_MESSAGES_AS_OBSERVATION=$TAU3_LIVE_ALL_MESSAGES_AS_OBSERVATION"
